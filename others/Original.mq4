...
void OnInit()
{
   ...
   service.addr = (AcceptFrom == aaeAny ? 0 /* INADDR_ANY */ : IPToAddr("127.0.0.1"));
...
int socketselect3264(int TestSocket)
{
   ...
   if (TerminalInfoInteger(TERMINAL_X64)) {
      ...
      return select(0, PollSocket64, PollSocket64, 0, waitfor);
      ...
      return select(0, PollSocket32, PollSocket32, 0, waitfor);
   }
}
